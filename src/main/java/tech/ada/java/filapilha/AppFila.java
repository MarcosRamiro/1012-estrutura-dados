...
public class AppFila {
    ...
    public static void main(String[] args) {
        ...
        Funcionario f5 = new Funcionario(5, "Maria", "Pessoas", 2323.56);

        ProcessarPagamentos processarPagamentos = new ProcessarPagamentosFilaPriorizada();
        processarPagamentos.inserir(f5);
